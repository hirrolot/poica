...
#define POICA_P_LANG_IS_EMPTY_STRUCT(variants)                                                     \
    BOOST_VMD_IS_EMPTY(BOOST_PP_EMPTY() BOOST_PP_SEQ_SIZE(                                         \
        BOOST_PP_SEQ_FOR_EACH(POICA_P_LANG_IS_EMPTY_STRUCT_VISIT, BOOST_PP_EMPTY(), variants)))

#define POICA_P_LANG_IS_EMPTY_STRUCT_VISIT(_r, _data, variant)                                     \
    POICA_OVERLOAD_ON_VARIANT(POICA_P_LANG_REPLACE_VARIANT_WITH_ITEM_, BOOST_PP_EMPTY(), (variant))

#define POICA_P_LANG_REPLACE_VARIANT_WITH_ITEM_VARIANT_KIND_EMPTY(_data, _variant_name)            \
    BOOST_PP_EMPTY()
...
#define POICA_P_LANG_REPLACE_VARIANT_WITH_ITEM_VARIANT_KIND_MANY(_data, _variant_name, _fields) (_)
